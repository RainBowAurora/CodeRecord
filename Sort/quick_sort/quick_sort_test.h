#ifndef __QUICK_SORT_TEST_H__
#define __QUICK_SORT_TEST_H__

#include <gtest/gtest.h>
#include "quick_sort.h"

TEST(quick_sort_test, c_array){
...
TEST(quick_sort_test, stl_vector){
