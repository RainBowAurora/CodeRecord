#ifndef __MERGE_SORT_TEST_H__
#define __MERGE_SORT_TEST_H__

#include <gtest/gtest.h>
#include "merge_sort.h"

TEST(merge_sort_test, c_array){
...
TEST(merge_sort_test, stl_vector){
