#ifndef __SELECTION_SORT_TEST_H__
#define __SELECTION_SORT_TEST_H__

#include <gtest/gtest.h>
#include "selection_sort.h"

TEST(selection_sort_test, c_array){
    ...
    SelectionSort(data1, data1+10);
    std::sort(comparedata2, comparedata2+10);
    SelectionSort(data2, data2+10);
    std::sort(comparedata3, comparedata3+10);
    SelectionSort(data3, data3+10);
    std::sort(comparedata4, comparedata4+1);
    SelectionSort(data4, data4+1);
...
TEST(selection_sort_test, stl_vector){
    ...
    SelectionSort(data1.begin(), data1.end());
    std::sort(comparedata2.begin(), comparedata2.end());
    SelectionSort(data2.begin(), data2.end());
    std::sort(comparedata3.begin(), comparedata3.end());
    SelectionSort(data3.begin(), data3.end());
    std::sort(comparedata4.begin(), comparedata4.end());
    SelectionSort(data4.begin(), data4.end());
...
#endif /*__SELECTION_SORT_TEST_H__*/